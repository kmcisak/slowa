...
<body>
	...
	<div class="container" style="margin-top: 15px;">
			...
			<div class="container-fluid">
				...
				<div id="navbar" class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="#"><span class="glyphicon glyphicon-user"></span> Profil:
		...
		<div class="container-tab">
			<form:form method="post" action="update" modelAttribute="wordsDtoForm">
			Nazwa zestawu <input name="wordsSet" value="${set.setsName}"></input>
