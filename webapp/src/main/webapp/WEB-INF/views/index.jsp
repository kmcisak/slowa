...
<body>
	...
	<div class="container" style="margin-top: 15px;">
		...
		<div class="container-fluid">
			...
			Dodaj własny zestaw! <a href="user/get" class="btn btn-default btn-sm" role="button">Utwórz zestaw</a>

			<div style="border-bottom: 1px solid #888; padding-top: 15px; font-size: 90%">Zestawy</div>

			<p>
				<c:forEach items="${allSets}" var="sets" varStatus="status">

					<a href="show/${sets.id}">${sets.setsName} (${fn:length(sets.words)})</a> | 
